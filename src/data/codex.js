...
export const CODEX = [
  ...
  },
  {
    ...
    entries: [
      ...
      { icon: '🏹', name: 'Fénnid', ga: 'warrior of the Fian', repr: 'the warrior sprite, borrowed until its own art lands', lore: 'A landless skirmisher of the Fian, won by your renown abroad. Fleet-footed and fierce — they join your muster once your foreign forays are known.' },
  ...
  },
  {
    ...
    entries: [
      ...
      { icon: '🍎', name: 'Orchard', ga: 'úllghort', repr: 'a crop chip that ripens then empties', lore: 'A second harvest of apples, grown from grafting-shoots won abroad. Learned once your first foray is done.' },
      { icon: '🏚️', name: 'Granary', ga: 'sciobol', repr: 'a granary chip', lore: 'Stores the harvest against winter and siege.' },
      { icon: '🏛️', name: 'Great Granary', ga: 'sciobol mór', repr: 'a granary chip in dressed stone', lore: 'A store of dressed stone, learned from foreign masons. Holds a harvest against the longest winter.' },
      { icon: '⚖️', name: 'Market', ga: 'margadh', repr: 'a market chip', lore: 'Turns goods to silver, and silver keeps your paid folk fed.' },
      { icon: '🎪', name: 'Fair-green', ga: 'aonach', repr: 'a market chip', lore: 'The great gathering-fair where the kingdoms come to trade. A market grown to the measure of a court.' },
  ...
  },
  {
    ...
    entries: [
      ...
      { icon: '☠️', name: 'The Menace', ga: 'an Ollphéist', repr: 'a great horned serpent coiled over a blighted zone', lore: 'An Ollphéist — a great serpent of the old tales — that lays waste to a stretch of your land. Nothing may be built where it coils, and its blight creeps outward each season. Muster a war-band and march on it: the fight is settled on the battlefield, not in the ráth.' },
    ],
  },
];
