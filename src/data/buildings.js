...
export const BUILDINGS = {
  ...
  granary: { label: 'Grain Store', sprite: 'grain_store', art: 'storehouse', states: 4, drawW: 2.9, icon: '🏚️', footprint: [2, 2], cost: 18, role: 'granary',
    desc: 'Holds the harvest. Markets draw grain from here along the roads.' },
  sciobolmor: { label: 'Great Granary', sprite: 'grain_store', art: 'storehouse', states: 4, drawW: 3.3, icon: '🏛️', footprint: [2, 2], cost: 26, role: 'granary', unlockLevel: 6,
    desc: 'A sciobol mór of dressed stone, learned from foreign masons. Holds the harvest against the longest winter or siege.' },
  market: { label: 'Market', sprite: 'market', art: 'market', states: 4, drawW: 2.9, icon: '🏪', footprint: [2, 2], cost: 16, role: 'market',
    desc: 'Restocks from road-connected stores and feeds the dwellings on its route.' },
  aonach: { label: 'Fair-green', sprite: 'market', art: 'market', states: 4, drawW: 3.3, icon: '🎪', footprint: [2, 2], cost: 22, role: 'market', unlockLevel: 7,
  ...
  well: { label: 'Well', sprite: 'well', scale: 0.78, icon: '💧', footprint: [1, 1], cost: 8, role: 'well', upkeep: 2,
